      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            durability and comfort. It features a sleek design that is perfect
            for any occasion. Whether you're dressing up for a formal event or
            keeping it casual, this product will complement your style.
          </p>
          <p>
            Our customers love this product for its versatility and timeless
            appeal. It's a must-have addition to any wardrobe. Order now and
